...
export function FaceScanner({
    ...
    return (
        <div className="relative w-full aspect-[16/11] rounded-3xl overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-950">
            {/* Webcam Feed */}
            <Webcam
                ref={webcamRef}
                audio={false}
            ...
            {/* Status overlay with modern glass morphism */}
                ...
                <div className="text-center text-white font-vazirmatn" dir="rtl">
                    {isLoading && (
                        ...
                        >
                            ...
                            <p className="text-base text-cyan-300">در حال بارگذاری سیستم تشخیص...</p>
                        </motion.div>
                    )}
                    ...
                    {error && (
                        <motion.p
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            className="text-base text-red-400 bg-red-500/10 py-2 px-4 rounded-full inline-block"
                        >
                            خطا: {error}
                        </motion.p>
                    )}
                        ...
                        >
                            {challengeText ? (
                                <motion.div
                                    ...
                                    className="bg-cyan-500/20 backdrop-blur-md py-4 px-8 rounded-2xl border border-cyan-400/30"
                                >
                                ...
                                <div className="space-y-2">
                                    ...
                                    {stableFaceDetected && isScanning && (
                                        <div className="w-64 h-1.5 mx-auto bg-gray-800/50 rounded-full overflow-hidden backdrop-blur-sm border border-gray-700/30">
                                            <motion.div
            ...
            <div className="absolute top-6 left-6 flex items-center gap-2">
                ...
                <span className="text-xs text-cyan-300 font-medium uppercase tracking-wider">LIVE</span>
            </div>
            <div className="absolute top-6 right-6 flex items-center gap-2" dir="rtl">
                <span className="text-xs text-gray-400 font-mono">{new Date().toLocaleTimeString('fa-IR')}</span>
            </div>
        </div>
    );
}
