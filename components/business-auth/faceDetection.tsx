...
import { FaceDetectionPayload } from "../../types/businessProfile";

interface FaceDetectionProps {
  onBack?: () => void;
  onContinue?: (data: FaceDetectionForm) => void;
  onSkip?: () => void;
  initialData?: FaceDetectionPayload;
  isLoading?: boolean;
}

type FaceDetectionForm = FaceDetectionPayload;
...
export function FaceDetection({ onBack, onContinue, onSkip, initialData, isLoading }: FaceDetectionProps) {
